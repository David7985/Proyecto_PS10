...
class AplicacionConPestanas(ctk.CTk):
    ...
    def mostrar_boleta(self):
        if not hasattr(self, 'pdf_viewer_boleta') or self.pdf_viewer_boleta is None:
            CTkMessagebox(title="Error", message="Primero genera una boleta.", icon="warning")
            return
    ...
    def eliminar_menu(self):
        ...
        nombre = self.treeview_menu.item(selected_item, "values")[0]
        self.pedido.eliminar_menu(nombre)
        self.actualizar_treeview_pedido()
        total = self.pedido.calcular_total()
        self.label_total.configure(text=f"Total: ${total:.2f}")
        CTkMessagebox(title="Éxito", message="Menú eliminado del pedido.", icon="check")
    ...
    def ingresar_ingrediente(self):
        ...
        CTkMessagebox(title="Éxito", message="Ingrediente agregado correctamente.", icon="check")
    ...
    def eliminar_ingrediente(self):
        ...
        self.actualizar_treeview()
        CTkMessagebox(title="Éxito", message="Ingrediente eliminado correctamente.", icon="check")
